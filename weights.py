...
def cotangent_laplacian(V: array, T: array) -> spmatrix:
    ...
    cot_weights = (cos_theta/np.sin(theta))*l/6     # <-- TODO
    ...
    for i in range(num_tets):        # <-- TODO
        for j in range(len(edges)):    # <-- TODO
            ...
            src = T[i][edges[j][0]]    # <-- TODO
            dst = T[i][edges[j][1]]     # <-- TODO
            ...
            triplets.append((src, dst, weight))         # <-- TODO
            triplets.append((dst, src, weight))        # <-- TODO
            triplets.append((src, src, -weight))       # <-- TODO
            triplets.append((dst, dst, -weight))         # <-- TODO
...
def bounded_biharmonic_weights(V: array, T: array, C: array) -> array:
    ...
    W = quadratic_optimization(Q, b, bc)      # <-- TODO
